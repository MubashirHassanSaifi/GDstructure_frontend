...
var overrides = __assign(__assign({}, base), { globals: getGlobals(rebass, {
        React: false,
    }), rules: {
...
var noUnescapedEntities = __assign(__assign({}, reactNoUnescapedEntities), { create: function (context) {
        var _a;
...
var getRemarkProcessor = function (searchFrom) {
    ...
    }, remarkProcessor().use({ settings: settings }).use(remarkStringify).use(remarkMdx))
        .freeze();
};
